...
namespace glamping_addventure3.Controllers
{
    ...
    public class PermisosController : Controller
    {
        ...
        public PermisosController(GlampingAddventure3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Idpermiso,NombrePermisos,EstadoPermisos,Descripcion,IsActive")] Permiso permiso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idpermiso,NombrePermisos,EstadoPermisos,Descripcion,IsActive")] Permiso permiso)
        {
